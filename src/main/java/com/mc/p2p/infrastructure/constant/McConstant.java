...
public class McConstant {
     ...
     * CAT_PRODUCT
     */
    public static final List<String> CAT_PRODUCT = Lists.newArrayList(
            "猫罐头", "进口猫粮", "猫砂", "逗猫棒", "猫猫小鱼干");
    /**
     * DOG_PRODUCT
     */
    public static final List<String> DOG_PRODUCT = Lists.newArrayList(
            "进口狗粮", "狗狗磨牙棒", "狗星人飞盘", "小狗皮球");
    /**
     * FISH_PRODUCT
     */
